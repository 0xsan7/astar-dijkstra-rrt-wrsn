...
class GraphGenerator:
    ...
    def generate_all_graphs(self):
        print("Generating complete comparison graphs...")
    ...
    def graph_computation_time_no_obstacles(self):
        ...
        ax.set_title("Computation Time Comparison - No Obstacles")
        ax.set_xticks(x)
        ax.set_xticklabels(self.node_counts)
        ax.legend()
        ax.grid(axis='y', alpha=0.3)
        ...
        plt.close()
        print("✓ Graph 3: Computation Time (No Obstacles)")
    ...
    def graph_computation_time_with_obstacles(self):
        ...
        ax.set_xlabel("Number of Nodes")
        ax.set_ylabel("Computation Time (ms)")
        ax.set_title("Computation Time Comparison - With Obstacles")
        ax.set_xticks(x)
        ax.set_xticklabels(self.node_counts)
        ax.legend()
        ax.grid(axis='y', alpha=0.3)
        ...
        plt.close()
        print("✓ Graph 4: Computation Time (With Obstacles)")
